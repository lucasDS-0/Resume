...
\begin{longtable}{l l}
    2017 - ongoing  & \textbf{Licenciatura en Ciencias de la Computación}\\
                    ...
                    & $\circ$ Functional Approach to EDSLs \shade{(15 hs)} \hfill (ECI2024) \\
                    & $\circ$ The Lambda-Calculus: \\
                    & $~~$ From Simple Types to Non-Idempotent Intersection Types \shade{(15 hs)} \hfill (ECI2024) \\
                    ...
                    & $\circ$ Linear Logic: Syntax, Models and Extensions \shade{(15 hs)} \hfill (ECI2023) \\
                    & $\circ$ Hetereogeneus programming models: \\
                    & $~~$ Portability, Performance and Programmability \shade{(15 hs)} \hfill (ECI2022) \\
                    \\
